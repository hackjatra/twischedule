...
<ul id="menu">
    ...
    <?php endif;?>
    <li id="menu_group"><?php print anchor('groups/admin/group',"Groups",array('class'=>'icon_house'))?></li>
    <li id="menu_group"><?php print anchor('schedule/admin/schedule',"Schedule",array('class'=>'icon_house'))?></li>
</ul>