...
<tr>
    <td><?php print img($this->config->item('admin_assets') . 'images/ac_permissions.png')?></td>
    <td>
    ...
    <td><?php print img($this->config->item('admin_assets') . 'images/ac_groups.png')?></td>
    <td>
...
<tr>
    <td><?php print img($this->config->item('admin_assets') . 'images/ac_resources.png')?></td>
    <td>
    ...
    <td><?php print img($this->config->item('admin_assets') . 'images/ac_actions.png')?></td>
    <td>
